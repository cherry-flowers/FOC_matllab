#ifndef RTW_HEADER_motor_simulink_acc_private_h_
#define RTW_HEADER_motor_simulink_acc_private_h_
#include "rtwtypes.h"
...
int_T * maxNewBufSzPtr ) ; real_T motor_simulink_acc_rt_TDelayInterpolate (
