...
MODEL                = motor_simulink
MODULES              = motor_simulink_acc.c motor_simulink_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/motor_simulink_acc.mexw64
MAKEFILE             = motor_simulink.mk
MATLAB_ROOT          = D:/MATLAB
ALT_MATLAB_ROOT      = D:/MATLAB
START_DIR            = D:/github_workspace/FOC_matllab
S_FUNCTIONS_LIB      = 
NUMST                = 5
NCSTATES             = 4
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/motor_simulink \
...
motor_simulink_acc.obj : $(START_DIR)/slprj/accel/motor_simulink/motor_simulink_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/motor_simulink/motor_simulink_acc.c

motor_simulink_acc_data.obj : $(START_DIR)/slprj/accel/motor_simulink/motor_simulink_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/motor_simulink/motor_simulink_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/motor_simulink/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/motor_simulink/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/motor_simulink/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/motor_simulink/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/motor_simulink/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/motor_simulink/rt_nonfinite.c
